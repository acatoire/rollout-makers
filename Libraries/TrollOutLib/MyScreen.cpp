...
#define DecDrawRect(A, B, C, D, E) drawRect(decX + A, decY + B, decX + C, decY + D, E);
  ...
  */
  ...
  switch (level)
  {
	case 0:
		...
		break;
	case 1:
		matrix_m->DecDrawRect(2, 13, 8, 12, 0xF980); 
		break;
	case 2:
		matrix_m->DecDrawRect(2, 13, 8, 11, 0xFA40); 
		break;
	case 3:
		matrix_m->DecDrawRect(2, 13, 8, 10, 0xFB40); 
		break;
	case 4:
		matrix_m->DecDrawRect(2, 13, 8, 9, 0xFD00); 
		break;
	case 5:
		matrix_m->DecDrawRect(2, 13, 8, 8, 0xFF20); 
		break;
	case 6:
		matrix_m->DecDrawRect(2, 13, 8, 7, 0xDF60); 
		break;
    case 7:
		matrix_m->DecDrawRect(2, 13, 8, 6, 0x9F40); 
		break;
	case 8:
		matrix_m->DecDrawRect(2, 13, 8, 5, 0x7741); 
		break;
	case 9:
		matrix_m->DecDrawRect(2, 13, 8, 4, 0x4FE0); 
		break;
	case 10:
		matrix_m->DecDrawRect(2, 13, 8, 3, 0x07E0); 
		break;	
  default:
    break;
  }
